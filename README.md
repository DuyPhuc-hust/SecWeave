...
Chưa có: redaction policy đầy đủ theo danh mục thật (§4.3.5, cần chốt cùng owner ở Gate 3 — hiện chỉ có floor tối thiểu), manifest cấp package (§4.3.3). Human Review Loop: chưa hiện thực. Cost Service thật: chưa hiện thực (kế tiếp theo weekly plan).
